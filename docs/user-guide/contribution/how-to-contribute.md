...
See separate instructions for [**IDEA**](https://www.jetbrains.com/help/idea/2016.3/importing-project-from-maven-model.html) and [**Eclipse**](https://javapapers.com/java/import-maven-project-into-eclipse/).   
